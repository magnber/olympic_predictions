"""
V2 Olympic Predictions - Streamlit App
...
st.set_page_config(
    page_title="V2 Olympic Predictions",
    page_icon="🏅",
    layout="wide"
)
...
st.title("🏅 V2 Olympic Predictions")
st.markdown("**Vinter-OL 2026 - Milano Cortina**")
...
if page == "Datagrunnlag":
    ...
    if not DB_PATH.exists():
        ...
        st.info("Kjør `python v2/run_pipeline.py` for å opprette databasen.")
        st.stop()
...
# ============================================================
    ...
    if df_pred is None:
        ...
        st.info("Kjør `python v2/predict.py` for å generere prediksjoner.")
        st.stop()
